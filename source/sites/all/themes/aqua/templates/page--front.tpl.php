	...
	<div class="footer_btm">
		<div class="footer_btm_inner">
			<?php if(!empty($pintrest)): ?>
				<a href='<?php print $pintrest; ?>' target='_blank' class='icon_pinterest'
				   title='Pinterest'><?php print t('Pinterest'); ?></a>
			<?php endif; ?>
			<?php if(!empty($twitter)): ?>
				<a href='<?php print $twitter; ?>' target='_blank' class='icon_tweet'
				   title='Twitter'><?php print t('Twitter'); ?></a>
			<?php endif; ?>
			<!--<a href="http://www.skype.com" class='icon_skype' title='Skype'>Skype</a> -->
			<?php if(!empty($gplus)): ?>
				<a href='<?php print $gplus; ?>' target='_blank' class='icon_google'
				   title='Google+'><?php print t('Google'); ?>+</a>
			<?php endif; ?>

			<?php if(!empty($facebook)): ?>
				<a href='<?php print $facebook; ?>' target='_blank' class='icon_facebook'
				   title='Facebook'><?php print t('Facebook'); ?></a>
			<?php endif; ?>
