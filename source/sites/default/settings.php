...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => 'bloomweb_optiken',
      'username' => 'bloomweb',
      'password' => 'rr40r900343',
      'host' => (($_SERVER['HTTP_HOST'] == 'optiken.bloomweb.co') ? 'mysql.bloomweb.co' : 'localhost'),
      'port' => '',
      'driver' => 'mysql',
      'prefix' => '',
    ),
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/devdesktop_optiken_local.inc'))
  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/devdesktop_optiken_local.inc');
//</DDSETTINGS>
